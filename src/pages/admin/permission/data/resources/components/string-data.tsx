    ...
    return (
        <div>
            ...
            <textarea rows={4} maxLength={200}
                className="w-full border-none rounded max-h-40 min-h-[38px] bg-gray-100 dark:bg-gray-700 text-sm transition duration-300 focus:ring-1 aria-invalid:ring-red-500"
                placeholder="请输入字符串值"
                {...props} />
        </div>
    )
